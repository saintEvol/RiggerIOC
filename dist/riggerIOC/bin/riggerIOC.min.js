...
(function (riggerIOC) {
    var InjectionBindInfo = /** @class */ (function () {
         ...
         * 该绑定产生的值是否是临时的
        */
        InjectionBindInfo.prototype.isInstanceTemporary = function () {
    ...
    */
    var ModuleContext = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ModuleContext.prototype, "injectionBinder", {
            get: function () {
                if (!this.mInjectionBinder) {
                    this.mInjectionBinder = new riggerIOC.ApplicationInjectionBinder(this.applicationContext.appId, this.applicationContext.getInjectionBinder(), this);
                }
                return this.mInjectionBinder;
            },
            enumerable: true,
        ...
        ModuleContext = __decorate([
            riggerIOC.autoDispose,
            __metadata("design:paramtypes", [riggerIOC.ApplicationContext])
        ], ModuleContext);
...
(function (riggerIOC) {
    ...
    var SignalCommandBindInfo = /** @class */ (function () {
        ...
        SignalCommandBindInfo.prototype.executeWaitableCommands = function (arg) {
            return __awaiter(this, void 0, void 0, function () {
                var ret, cmd, cmdInfo, canDispose, injectionBindInfo, i, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ret = null;
