    ...
    var BaseWaitable = /** @class */ (function () {
        ...
        */
        ...
        BaseWaitable.prototype.wait = function () {
            ...
            if (this.mIsCanceled)
                return this.mReason;
            this.waitingTask = riggerIOC.waitFor(this.startTask.apply(this, args));
            return this.waitingTask;
        };
        /**
         * 任务完成
...
(function (riggerIOC) {
    var ApplicationInjectionBinder = /** @class */ (function (_super) {
        ...
        function ApplicationInjectionBinder(appId, injectionBinder) {
            var _this = _super.call(this) || this;
            _this.infos = {};
            _this.appId = appId;
        ...
        ApplicationInjectionBinder.prototype.bind = function (cls) {
            ...
            if (!this.infos)
                this.infos = {};
            this.infos[riggerIOC.InjectionWrapper.getId(cls)] = info;
            return info;
        };
        ...
        Object.defineProperty(ApplicationContext.prototype, "injectionBinder", {
            get: function () {
                if (!this.mInjectionBinder) {
                    this.mInjectionBinder = new riggerIOC.ApplicationInjectionBinder(this.appId, riggerIOC.InjectionBinder.instance);
                }
    ...
    */
    var ModuleContext = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ModuleContext.prototype, "injectionBinder", {
            get: function () {
                if (!this.mInjectionBinder) {
                    this.mInjectionBinder = new riggerIOC.ApplicationInjectionBinder(this.applicationContext.appId, this.applicationContext.getInjectionBinder());
                }
                return this.mInjectionBinder;
            },
            enumerable: true,
