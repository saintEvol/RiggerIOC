...
var FightModelT = /** @class */ (function (_super) {
    __extends(FightModelT, _super);
    // @riggerIOC.inject(FightServer)
    // private fightServer: FightServer
    function FightModelT() {
        return _super.call(this) || this;
        // this.fightServer;
    }
    FightModelT.prototype.dispose = function () {
...
var FightModel = /** @class */ (function (_super) {
    ...
    FightModel.prototype.subHp = function (hp) {
        this.fighter.hp = Math.max(0, this.fighter.hp - hp);
    };
    FightModel.prototype.isLive = function (test) {
        console.log('fight command idx:' + test);
        return this.fighter.hp > 0;
    };
    Object.defineProperty(FightModel.prototype, "hp", {
        get: function () {
    ...
    FightModel.prototype.setFighterInfo = function (name, hp) {
        console.log("[time:" + Laya.Browser.now() + "]set fighter info,name:" + name + ", hp:" + hp);
        if (!this.fighter)
            return this.fighter = new FighterInfo(name, hp);
        this.fighter.name = name;
        this.fighter.hp = hp;
    };
    __decorate([
        riggerIOC.inject(FightModelT)
    ], FightModel.prototype, "modelT", void 0);
    return FightModel;
}(riggerIOC.Model));
/*
* 初始化Fighter的信号
*/
var InitFighterInfoSignal = /** @class */ (function (_super) {
    __extends(InitFighterInfoSignal, _super);
    function InitFighterInfoSignal() {
        return _super.call(this) || this;
    }
    return InitFighterInfoSignal;
}(riggerIOC.Signal));
/*
 * Copyright 2018 Yang Wu.
 *
...
var FightServer = /** @class */ (function (_super) {
    ...
    FightServer.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.model;
                        return [4 /*yield*/, riggerIOC.waitForSeconds(1000)];
                    case 1:
                        _a.sent();
                        info = new FighterInfo("Laya", 100);
    ...
    ], FightServer.prototype, "model", void 0);
    __decorate([
        riggerIOC.inject(InitFighterInfoSignal)
    ], FightServer.prototype, "initSignal", void 0);
    return FightServer;
}(riggerIOC.Server));
/*
 * Copyright 2018 Yang Wu.
...
* name;
*/
var StartLoginSignal = /** @class */ (function (_super) {
    __extends(StartLoginSignal, _super);
    function StartLoginSignal() {
        var _this = _super.call(this) || this;
        console.log("now constructor StartLoginSignal");
        return _this;
    }
    StartLoginSignal.prototype.dispose = function () {
        console.log("now dispose StartLoginSignal");
        _super.prototype.dispose.call(this);
    };
    return StartLoginSignal;
}(riggerIOC.Signal));
/*
* name;
*/
var LoginSuccessSignal = /** @class */ (function (_super) {
    ...
    LoginSuccessSignal.prototype.dispose = function () {
...
var riggerIOC;
(function (riggerIOC) {
    var InjectionStatistics = /** @class */ (function () {
        function InjectionStatistics(id, owner, fromConstructor, toConstructor) {
            this.id = id;
            this.owner = owner;
            this.fromConstructor = fromConstructor;
            this.toConstructor = toConstructor;
        }
        InjectionStatistics.prototype.dispose = function () {
            this.owner = this.fromConstructor = this.toConstructor = null;
        };
        return InjectionStatistics;
    }());
    riggerIOC.InjectionStatistics = InjectionStatistics;
    /**
     * 应用上下文，表示一个应用
     * 可以等待应用启动完成
     */
    var ApplicationContext = /** @class */ (function (_super) {
        ...
        Object.defineProperty(ApplicationContext, "debug", {
            /**
        ...
        ApplicationContext.mDebug = false;
        /**
         * 当前自增的appId
         */
...
* name;
*/
var StartFightSignal = /** @class */ (function (_super) {
    __extends(StartFightSignal, _super);
    function StartFightSignal() {
        return _super.call(this) || this;
    }
    return StartFightSignal;
}(riggerIOC.Signal));
///<reference path='../SERVERS/FightServer.ts'/>
var BaseFightCommand = /** @class */ (function (_super) {
    __extends(BaseFightCommand, _super);
    function BaseFightCommand() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        riggerIOC.inject(FightServer)
    ], BaseFightCommand.prototype, "fightServer", void 0);
    return BaseFightCommand;
}(riggerIOC.WaitableCommand));
/*
 * Copyright 2018 Yang Wu.
 *
 *	Licensed under the Apache License, Version 2.0 (the "License");
...
* name;
*/
var MyAppContext = /** @class */ (function (_super) {
    __extends(MyAppContext, _super);
    function MyAppContext() {
        return _super.call(this) || this;
    }
    MyAppContext.prototype.bindInjections = function () {
        console.log("bind app level injections.");
    };
    MyAppContext.prototype.bindCommands = function () {
        console.log("bind app level commands.");
    };
    MyAppContext.prototype.registerModuleContexts = function () {
        // 分别添加登录模块和战斗模块
    ...
    MyAppContext.prototype.onInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("on start");
                        return [4 /*yield*/, this.timer.forSeconds(5).wait()];
                    case 1:
                        _a.sent();
    ...
    ], MyAppContext.prototype, "timer", void 0);
    return MyAppContext;
...
* name;
*/
var WaitForSeconds = /** @class */ (function (_super) {
    __extends(WaitForSeconds, _super);
    function WaitForSeconds() {
        return _super.call(this) || this;
    }
    WaitForSeconds.prototype.startTask = function () {
        _super.prototype.startTask.call(this);
        setTimeout(this.onTimeOut, 2000, this);
        return this;
    };
    WaitForSeconds.prototype.onTimeOut = function (obj) {
...
var FightModule = /** @class */ (function (_super) {
    ...
    function FightModule(appContext) {
        return _super.call(this, appContext) || this;
    }
    FightModule.prototype.onStart = function () {
        this.done();
    };
    FightModule.prototype.dispose = function () {
        console.log("now dispose fight module");
    };
    FightModule.prototype.bindInjections = function () {
    ...
    FightModule.prototype.bindCommands = function () {
    ...
    FightModule.prototype.bindMediators = function () {
...
(function (riggerIOC) {
    var ApplicationInjectionBinder = /** @class */ (function (_super) {
        ...
        ApplicationInjectionBinder.prototype.bind = function (cls) {
            ...
            // 如果是debug状态，则进行统计
            if (riggerIOC.ApplicationContext.debug) {
                var app = riggerIOC.ApplicationContext.getApplication(this.appId);
                var old = app.injectionStatistics[bindId] || [];
                // 移除owner一样的
                var owner_1 = this.owner;
                old = old.filter(function (v, idx, arr) { return v.owner !== owner_1; });
                old.push(new riggerIOC.InjectionStatistics(bindId, owner_1, cls));
...
* name;
*/
var DieCommand = /** @class */ (function (_super) {
    __extends(DieCommand, _super);
    function DieCommand() {
        return _super.call(this) || this;
    }
    DieCommand.prototype.execute = function () {
        console.log("[time:" + Laya.Browser.now() + "]fightr die");
        this.done();
        return this;
    };
    DieCommand.prototype.onCancel = function (r) {
    };
    return DieCommand;
}(riggerIOC.WaitableCommand));
/*
...
var FightCommand = /** @class */ (function (_super) {
    ...
    FightCommand.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            var temp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        temp = FightCommand.idx++;
                        _a.label = 1;
                    case 1:
                        if (!!this.isCanceled()) return [3 /*break*/, 5];
                        if (!this.fightModel.isLive(temp)) return [3 /*break*/, 3];
                        this.fightModel.subHp(10);
                        console.log("[time:" + Laya.Browser.now() + "]be hitted and hurt:10, now  hp:" + this.fightModel.hp);
                        return [4 /*yield*/, riggerIOC.waitForSeconds(2000)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
    ...
    FightCommand.prototype.onCancel = function () {
        console.log("cancel fight command");
    };
    FightCommand.prototype.dispose = function () {
    ...
    __decorate([
        riggerIOC.inject(FightModel)
    ], FightCommand.prototype, "fightModel", void 0);
    return FightCommand;
}(BaseFightCommand));
/*
 * Copyright 2018 Yang Wu.
...
var InitFighterInfoCommand = /** @class */ (function (_super) {
    __extends(InitFighterInfoCommand, _super);
    function InitFighterInfoCommand() {
        return _super.call(this) || this;
    }
    InitFighterInfoCommand.prototype.execute = function (info) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    InitFighterInfoCommand.prototype.onCancel = function () {
        console.log("on InitFighterInfoCommand canceled");
    };
    __decorate([
        riggerIOC.inject(FightModel)
    ], InitFighterInfoCommand.prototype, "model", void 0);
    __decorate([
        riggerIOC.inject(StartFightSignal)
    ], InitFighterInfoCommand.prototype, "startFightSignal", void 0);
    return InitFighterInfoCommand;
}(riggerIOC.WaitableCommand));
/*
* name;
*/
var SearchEnemyCommand = /** @class */ (function (_super) {
    __extends(SearchEnemyCommand, _super);
    function SearchEnemyCommand() {
        return _super.call(this) || this;
    }
    SearchEnemyCommand.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    SearchEnemyCommand.prototype.onCancel = function () {
    };
    return SearchEnemyCommand;
}(riggerIOC.WaitableCommand));
/*
* name;
*/
var ChildDummyModel = /** @class */ (function () {
    function ChildDummyModel() {
    }
    ChildDummyModel.prototype.dispose = function () {
    };
    return ChildDummyModel;
}());
/*
* name;
*/
...
* name;
*/
var FighterInfo = /** @class */ (function () {
    function FighterInfo(name, hp) {
        this.name = name;
        this.hp = hp;
    }
    return FighterInfo;
...
var LoginModule = /** @class */ (function (_super) {
    ...
    ], LoginModule.prototype, "startLoginSignal", void 0);
    __decorate([
        riggerIOC.inject(LoginSuccessSignal)
    ], LoginModule.prototype, "loginSuccessSignal", void 0);
...
* name;
*/
var LoginSuccessfulCommand = /** @class */ (function (_super) {
    __extends(LoginSuccessfulCommand, _super);
    function LoginSuccessfulCommand() {
        return _super.call(this) || this;
    }
    LoginSuccessfulCommand.prototype.execute = function (playerId) {
    ...
    __decorate([
        riggerIOC.inject(LoginSuccessSignal)
    ], LoginSuccessfulCommand.prototype, "succSignal", void 0);
    LoginSuccessfulCommand = __decorate([
        riggerIOC.autoDispose
    ], LoginSuccessfulCommand);
    return LoginSuccessfulCommand;
}(riggerIOC.Command));
/*
* name;
*/
var StartLoginCommand = /** @class */ (function (_super) {
    __extends(StartLoginCommand, _super);
    // @riggerIOC.inject(LoginSuccessSignal)
    // private successLoginSignal: LoginSuccessSignal;
    function StartLoginCommand() {
        return _super.call(this) || this;
    }
    StartLoginCommand.prototype.execute = function (playerId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    StartLoginCommand.prototype.onCancel = function () {
    };
    StartLoginCommand = __decorate([
        riggerIOC.autoDispose
    ], StartLoginCommand);
...
var GameMain = /** @class */ (function () {
    ...
    GameMain.prototype.testApp = function () {
        return __awaiter(this, void 0, void 0, function () {
            var app;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    GameMain.prototype.testSeq = function () {
        return __awaiter(this, void 0, void 0, function () {
            var seq, comHandler, cancelHandler, t1, t2, t3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        seq = new riggerIOC.TaskExecutor();
                        ...
                        comHandler = riggerIOC.Handler.create(this, this.onTaskComplete, null, false);
                        cancelHandler = riggerIOC.Handler.create(this, this.onTaskCanceled, null, false);
                        t1 = new riggerIOC.WaitForTime();
                        t1.forMSeconds(2000, false);
                        seq.add(t1, comHandler, ["t1"], cancelHandler, ["t1"]);
                        t2 = new riggerIOC.WaitForTime();
                        t2.forSeconds(3, false);
                        seq.add(t2, comHandler, ["t2"], cancelHandler, ["t2"]);
                        t3 = new riggerIOC.WaitForTime();
                        t3.reset();
                        t3.forSeconds(7, false);
                        seq.add(t3, comHandler, ["t3"], cancelHandler, ["t3"]);
                        // setTimeout(this.interrupt, 2500, seq);
                        return [4 /*yield*/, seq.execute()];
                    case 1:
                        // setTimeout(this.interrupt, 2500, seq);
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        t = new riggerIOC.WaitForTime();
                        console.log("before wait for 5");
                        return [4 /*yield*/, t.forSeconds(5).wait()];
                    case 2:
                        _a.sent();
                        ...
                        t.reset();
                        return [4 /*yield*/, t.forMSeconds(5000).wait()];
                    case 3:
                        ret = _a.sent();
                        if (ret.isFailed) {
    ...
    GameMain.prototype.testFrame = function () {
        return __awaiter(this, void 0, void 0, function () {
            var frame;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        frame = new riggerIOC.WaitForTime();
                        _a.label = 1;
                    case 1:
                        if (!true) return [3 /*break*/, 3];
                        console.log("after a frame");
                        return [4 /*yield*/, frame.forever().wait()];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 1];
    ...
    GameMain.prototype.testConcat = function () {
        var arr1 = [1, 2, 3];
        var ret = [].concat(arr1, 1);
        console.log("ret:" + ret.toString());
        console.log("arr1:" + arr1.toString());
    };
    GameMain.prototype.onSeqComplete = function () {
        console.log("[time:" + Laya.Browser.now() + "]seq exec complete!");
    };
    GameMain.prototype.onSeqCanceled = function () {
        console.log("[time:" + Laya.Browser.now() + "]seq exec canceled");
    };
    GameMain.prototype.onTaskComplete = function (taskName) {
        console.log("[time:" + Laya.Browser.now() + "]task:" + taskName + " complete");
    };
    GameMain.prototype.onTaskCanceled = function (taskName, reason) {
        console.log("[time:" + Laya.Browser.now() + "]task:" + taskName + " canceled, reason:" + reason);
    };
    GameMain.prototype.interrupt = function (container) {
