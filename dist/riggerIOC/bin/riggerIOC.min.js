...
(function (riggerIOC) {
    var Signal = /** @class */ (function () {
         ...
         * @param args
         */
        Signal.prototype.on = function (caller, method, args) {
         ...
         * @param args
         */
        Signal.prototype.once = function (caller, method, args) {
            this.makeSureListenerManager();
...
(function (riggerIOC) {
    ...
    var SignalCommandBindInfo = /** @class */ (function () {
        ...
        SignalCommandBindInfo.prototype.executeCommands = function (arg) {
            return __awaiter(this, void 0, void 0, function () {
                var ret, i, cmd, cmdInfo;
                return __generator(this, function (_a) {
                    ret = null;
                    for (i = 0; i < this.commandsCls.length; ++i) {
                        cmd = void 0;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            cmd.execute.apply(cmd, arg.concat(ret));
