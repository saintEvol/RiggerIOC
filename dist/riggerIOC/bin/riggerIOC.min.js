    ...
    var TaskExecutor = /** @class */ (function () {
        ...
        */
        ...
        TaskExecutor.prototype.execute = function () {
            return __awaiter(this, void 0, void 0, function () {
                var executors, singleArgs, singleHandlers, cancelHandlers, cancelArgs, tempCursor, ret, reason_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.mCursor = 0;
                            tempCursor = this.mCursor;
                            _a.label = 1;
                        case 1:
                            if (!(this.mCursor < executors.length)) return [3 /*break*/, 7];
                            _a.label = 2;
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, executors[tempCursor].wait()];
                        case 3:
                            ret = _a.sent();
                        ...
                        case 5:
                            ...
                            _a.label = 6;
                        case 6:
                            ++this.mCursor, tempCursor = this.mCursor;
                            return [3 /*break*/, 1];
                        case 7:
        ...
        TaskExecutor.prototype.cancel = function (reason) {
            ...
            if (!this.isRunning)
                return;
            var tempCursor = this.mCursor;
            this.mCursor = -1;
            this.mTasks[tempCursor].cancel(reason);
            for (var i = tempCursor; i < this.mSingleCancelHandlers.length; ++i) {
