...
(function (riggerIOC) {
    ...
    var InjectionTrack = /** @class */ (function () {
        ...
        InjectionTrack.prototype.toString = function () {
            ...
            var error = getDisposeException(this.inst);
    ...
    function addOwnerShip(obj, attrName, owner, acc, ifInjected) {
        ...
        if (idx < 0) {
            // 初始化
            var ownerTrack = riggerIOC.insertInjectionTrack(owner, ifInjected);
    ...
    function getDisposeException(obj) {
        if (!obj)
            return null;
        return obj["$riggerIOC_dispose_stack"];
    }
    riggerIOC.getDisposeException = getDisposeException;
    function setDisposeException(obj, error) {
        if (!obj)
            return;
        obj["$riggerIOC_dispose_stack"] = error;
    }
    riggerIOC.setDisposeException = setDisposeException;
    /**
     * 注入装饰器
     * @param ctr
     */
...
(function (riggerIOC) {
    ...
    var ApplicationContextAnalyser = /** @class */ (function () {
        ...
        Object.defineProperty(ApplicationContextAnalyser.prototype, "stickyInsts", {
            ...
            get: function () {
                var ret = [];
                for (var i = 0; i < this.injectionTracks.length; ++i) {
                    var tempTrack = this.injectionTracks[i];
        ...
        Object.defineProperty(ApplicationContextAnalyser.prototype, "errorInsts", {
            /**
             * 有错误的实例
             */
            get: function () {
                ...
                for (var i = 0; i < this.injectionTracks.length; ++i) {
                    var tempTrack = this.injectionTracks[i];
                    var error = riggerIOC.getDisposeException(tempTrack.inst);
                    if (error) {
                        ret.push(tempTrack);
                    }
                }
